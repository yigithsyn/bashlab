...
static const char *program_json = "{\"name\":\"wavelen2freq\",\"desc\":\"convert wavelength to frequency\",\"osOnly\":false,\"pargs\":[{\"name\":\"wavelength\",\"minc\":1,\"maxc\":1,\"desc\":\"wavelength value(s)\"}],\"oargs\":[],\"opts\":[]}";
...
/* ======================================================================== */
MAIN:;
  struct arg_str *arg_wavelen = (struct arg_str *)argtable[0];

INPUTT:;
  size_t Nvar = 1;
  struct arg_str *var_args[BL_MAX_ARG_NUM] = {arg_wavelen};
  ...
  char var_types[BL_MAX_ARG_NUM][10] = {"double"};
  number_t *var_vals[BL_MAX_ARG_NUM] = {NULL};
