...
static const char *program_json = "{\"name\":\"ffdist\",\"desc\":\"calculates far-field (Fraunhofer) distance of an aperture\",\"osOnly\":false,\"pargs\":[{\"name\":\"freq\",\"minc\":1,\"maxc\":1,\"desc\":\"frequency in Hertz [Hz]\"},{\"name\":\"D\",\"minc\":1,\"maxc\":1,\"desc\":\"aperture cross-sectional size in meters [m]\"}],\"oargs\":[],\"opts\":[]}";
