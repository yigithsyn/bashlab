...
static const char *program_json = "{\"name\":\"serialport.ping\",\"desc\":\"send command and read response from serial port\",\"osOnly\":true,\"pargs\":[{\"name\":\"port\",\"minc\":1,\"maxc\":1,\"desc\":\"port name\"},{\"name\":\"baudrate\",\"minc\":1,\"maxc\":1,\"desc\":\"baudrate of port\"},{\"name\":\"buffer\",\"minc\":1,\"maxc\":1,\"desc\":\"string buffer to write into port\"}],\"oargs\":[{\"short\":\"b\",\"long\":\"bits\",\"name\":\"bits\",\"minc\":1,\"maxc\":1,\"desc\":\"number of data bits\"}],\"opts\":[]}";
