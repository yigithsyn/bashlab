...
static const char *program_json = "{\"name\":\"freq2wavelen\",\"desc\":\"convert frequency to wavelength\",\"osOnly\":false,\"pargs\":[{\"name\":\"freq\",\"minc\":1,\"maxc\":1,\"desc\":\"frequency value\"}],\"oargs\":[],\"opts\":[]}";
...
INPUTT:;
  size_t Nvar = 1;
  struct arg_str *var_args[BL_MAX_ARG_NUM] = {arg_freq};
